export const advisors = [
    {
        id : 1,
        name : 'Morgan Beller',
        title: 'General Partner, NFX and Co-creator, Diem≋ (fka Libra)',
        text: '',
        ...
        socials: {
            ...
            github : '',
            email : '',
            linkedin : 'https://www.linkedin.com/in/morganbeller/',
        }
    },
    {
        id : 2,
        name : 'Ethan Buchman',
        title: 'Co-founder, Tendermint and Co-founder, Cosmos',
        text: '',
    ...
    },
    {
        id : 3,
        name : 'Zaki Manian',
        title: 'Co-creator, IBC and early Cosmos contributor',
        text: '',
    ...
    },
    {
        id : 5,
        name : 'George Danezis',
        title: 'Professor of Security and Privacy Engineering, University College London',
        text: '',
